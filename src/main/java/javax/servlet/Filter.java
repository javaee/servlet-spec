 ...
 * (a servlet or static content), or on the response from a resource, or both. <br><br>
...
public interface Filter {
	 ...
	 * 4. b) <strong>or</strong> not pass on the request/response pair to the next entity in the filter chain to
     * block the request processing<br>
